...
export default function CompassTools(){
 ...
 function consumeHeading(raw,{source,ios=false,accuracy=NaN}){
  ...
  if(ios&&Number.isFinite(accuracy)&&accuracy>35)setWarning('La precisión magnética es baja. Aleja el móvil de fundas magnéticas, llaves, altavoces y objetos metálicos. Después muévelo lentamente dibujando un 8 en el aire.')
  else if(spread>18)setWarning('Señal magnética inestable. Aleja el móvil de objetos metálicos y calibra el sensor moviendo el teléfono lentamente en forma de 8.')
 }
