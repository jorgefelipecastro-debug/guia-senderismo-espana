...
export const OFFLINE_MAP_PROFILES = {
  ...
  community: { minZoom: 7, maxZoom: 12, label: 'Detalle de comunidad' },
  province: { minZoom: 8, maxZoom: 13, label: 'Detalle de provincia' },
  route: { minZoom: 10, maxZoom: 15, label: 'Detalle de ruta' },
};

export const OFFLINE_MAP_TILE_SIZE = 256;
