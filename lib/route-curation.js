...
const CURATED_ROUTES = [
  {
    ...
    metricsSource: 'Distancia y tiempo: FEMECV · perfil: trazado OSM y elevación Open-Meteo',
  ...
  },
  {
    ...
    metricsSource: 'Calculado con el trazado OpenStreetMap y el modelo de elevación Open-Meteo',
    image: {
