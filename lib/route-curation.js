...
const CURATED_ROUTES = [
  ...
  },
  {
    ...
    metricsSource: 'Clot de Galvany / trazado público',
    metricsSourceUrl: 'https://clotdegalvany.es/rutas/',
    image: {
  ...
  },
  {
    ...
    metricsSource: 'Clot de Galvany / trazado público',
    metricsSourceUrl: 'https://clotdegalvany.es/rutas/ruta-el-monte-y-la-loma/',
    image: {
