...
const CACHE_NAME = 'encumbrate-public-v29';
const APP_SHELL = ['/', '/manifest.webmanifest', '/icon-192-v2.jpg', '/icon-512-v2.jpg', '/apple-touch-icon-v2.jpg', '/offline.html', '/offline/viewer.mjs', '/offline/maps.mjs', '/offline/mosaic.mjs', '/offline/route-tiles.mjs', '/offline/nav.mjs', '/offline/tile-map.mjs', '/offline/api.mjs'];
